      ...
      try {
        ...
        for (const line of lines) {
          try {
            ...
            if (!modelId && ev.type === 'model_change') modelId = ev.modelId;
        ...
        liveRuns.push({ runId: d.name, runIndex: parseInt(m[1], 10), jsonl, firstTs, firstUserText, modelId, mtime: stat.mtimeMs });
      } catch {}
    }
  }
